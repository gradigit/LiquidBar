...
ZIP_PATH="${LIQUIDBAR_RELEASE_ZIP_PATH:-${ROOT_DIR}/build/release/LiquidBar-${LIQUIDBAR_RELEASE_VERSION:-1.0.1}.zip}"
DMG_PATH="${LIQUIDBAR_RELEASE_DMG_PATH:-${ROOT_DIR}/build/release/LiquidBar-${LIQUIDBAR_RELEASE_VERSION:-1.0.1}.dmg}"
BUNDLE_ID="${LIQUIDBAR_BUNDLE_ID:-com.gradigit.LiquidBar}"
VERSION="${LIQUIDBAR_RELEASE_VERSION:-1.0.1}"
