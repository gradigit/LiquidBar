...
시스템 표시기, 세밀한 설정을 macOS 자체를 대체하지 않고 자연스럽게 더합니다.
...
구성 요소는 검토, 빌드, 비활성화가 쉽도록 분리되어 있습니다.
...
v1 기본 설정은 아이콘 중심 작업 표시줄, 오른쪽에 고정된 시스템 표시기, `Cmd-Tab`
...
준비될 때까지 ad-hoc 서명 상태이거나 unsigned로 표시될 수 있습니다. 사이드바
